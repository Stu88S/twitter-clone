...
const RightSidebar = () => {
	return (
		<section className=" mt-2 w-[390px] hidden sticky top-2 xl:flex flex-col items-stretch h-[90vh] px-6">
			<div>
				<div className="relative w-full h-full group">
					<input
						...
						type="text"
						placeholder="Search"
						className="outline-none peer focus:border-primary focus:border bg-neutral-900/90 w-full h-full rounded-xl py-4 pl-10 pr-4"
					/>
					<label
						htmlFor="searchBox"
